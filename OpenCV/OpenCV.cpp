...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	while (true)
	{
		...
		//读取图像
		Mat src00 = imread("..\\USBCamera\\bin\\Debug\\image\\00.jpg");  //352*288
		Mat src01 = imread("..\\USBCamera\\bin\\Debug\\image\\01.jpg");
		Mat src02 = imread("..\\USBCamera\\bin\\Debug\\image\\02.jpg");
		Mat src03 = imread("..\\USBCamera\\bin\\Debug\\image\\03.jpg");
		Mat src10 = imread("..\\USBCamera\\bin\\Debug\\image\\10.jpg");  //352*288
		Mat src11 = imread("..\\USBCamera\\bin\\Debug\\image\\11.jpg");
		Mat src12 = imread("..\\USBCamera\\bin\\Debug\\image\\12.jpg");
		Mat src13 = imread("..\\USBCamera\\bin\\Debug\\image\\13.jpg");
		//我写的自动导出
		{
			//////////////////////////////////显示图片代码
			//{
...
void RectInit(void)
{
	...
	rect0[0] = Rect(366, 354, 33, 40);
	rect0[1] = Rect(212, 221, 40, 36);
	rect0[2] = Rect(434, 280, 36, 42);
	rect0[3] = Rect(351, 213, 43, 37);
	rect0[4] = Rect(498, 208, 39, 41);
	rect0[5] = Rect(419, 137, 44, 44);
	rect0[6] = Rect(349, 66, 40, 41);

	rect1[0] = Rect(283, 116, 18, 14);
	rect1[1] = Rect(283, 154, 18, 20);
	rect1[2] = Rect(261, 200, 34, 25);
	rect1[3] = Rect(262, 255, 33, 19);
	rect1[4] = Rect(279, 294, 25, 17);
	rect1[5] = Rect(284, 326, 22, 13);
	rect1[6] = Rect(338, 114, 26, 17);
	rect1[7] = Rect(339, 154, 27, 19);
	rect1[8] = Rect(339, 198, 33, 28);
	rect1[9] = Rect(337, 255, 33, 20);
	rect1[10] = Rect(335, 296, 31, 18);
	rect1[11] = Rect(339, 327, 25, 12);
	rect1[12] = Rect(398, 114, 24, 18);
	rect1[13] = Rect(401, 150, 18, 24);
	rect1[14] = Rect(413, 196, 29, 29);
	rect1[15] = Rect(411, 251, 27, 22);
	rect1[16] = Rect(401, 296, 16, 15);
	rect1[17] = Rect(399, 327, 17, 14);

	rect2[0] = Rect(140, 227, 40, 41);
	rect2[1] = Rect(221, 157, 49, 40);
	rect2[2] = Rect(300, 94, 43, 38);
	rect2[3] = Rect(212, 309, 46, 36);
	rect2[4] = Rect(292, 237, 42, 41);
	rect2[5] = Rect(281, 388, 42, 41);
	rect2[6] = Rect(440, 244, 41, 43);

	rect3[0] = Rect(442, 382, 33, 17);
	rect3[1] = Rect(461, 331, 42, 25);
	rect3[2] = Rect(490, 259, 42, 34);
	rect3[3] = Rect(485, 159, 51, 35);
	rect3[4] = Rect(454, 92, 37, 23);
	rect3[5] = Rect(440, 52, 31, 15);
	rect3[6] = Rect(343, 381, 38, 18);
	rect3[7] = Rect(346, 336, 40, 24);
	rect3[8] = Rect(351, 258, 48, 33);
	rect3[9] = Rect(347, 162, 50, 34);
	rect3[10] = Rect(344, 94, 41, 25);
	rect3[11] = Rect(344, 47, 32, 18);
	rect3[12] = Rect(252, 381, 34, 16);
	rect3[13] = Rect(230, 333, 46, 25);
	rect3[14] = Rect(214, 267, 51, 33);
	rect3[15] = Rect(210, 166, 44, 35);
	rect3[16] = Rect(237, 97, 37, 22);
	rect3[17] = Rect(251, 49, 30, 17);
